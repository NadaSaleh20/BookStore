...
namespace WebApplication8
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserClaimsPrincipalFactory<Users>, Cliam>();
            ...
            services.Configure<NewBookAlert>("First",Configuration.GetSection("NewBookAlert"));
            services.Configure<NewBookAlert>("Second",Configuration.GetSection("SecondNewBookAlert"));
